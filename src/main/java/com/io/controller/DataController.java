...
import com.io.service.DataService;
...
public class DataController {
	...
	@Autowired
	DataService dataService; //This service inserts all data into database
	...
	public String addData() throws IOException {
		dataService.addData(worksheet.getData(path));
		return "<h1>Data copied from Excel to Database(MySQL) Successfully.......</h1>";
	}
}
